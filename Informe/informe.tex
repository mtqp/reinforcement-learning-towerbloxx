...
Para responder a las distintas preguntas que uno se puede plantear con respecto a los algoritmos y sus parametros, corrimos los siguientes experimentos, siempre el objetivo era llegar a los 20 pisos
...
\includegraphics[scale=0.6]{Graficos/epsilonsQ.png}
...
Es decir, para el agente que se acerca a mejores resultados, no fue tan necesario explorar, sino explotar las soluci\'ones encontrada.

\includegraphics[scale=0.6]{Graficos/alphasQ.png}
...
\includegraphics[scale=0.6]{Graficos/gammasQ.png}
